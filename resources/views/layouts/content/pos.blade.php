...
@section('content')
                    ...
                    <div class="pos-dropdown__dropdown-box dropdown-box mt-10 absolute top-0 right-0 z-20">
                        <div class="dropdown-box__content box p-2">
                            <a href=""
                                ...
                                <i data-feather="activity" class="w-4 h-4 mr-2"></i> <span class="truncate">INV-0206020 -
                                    Denzel Washington</span> </a>
                            <a href=""
                                class="flex items-center block p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md">
                                <i data-feather="activity" class="w-4 h-4 mr-2"></i> <span class="truncate">INV-0206022 -
                                    Leonardo DiCaprio</span> </a>
                            <a href=""
                                class="flex items-center block p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md">
                                <i data-feather="activity" class="w-4 h-4 mr-2"></i> <span class="truncate">INV-0206021 -
                                    Tom Cruise</span> </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-12 gap-5 mt-5">
                    ...
                    @foreach ($barangs as $barang)
                        <a href="javascript:;" data-toggle="modal" data-target="#add-item-modal"
                            ...
                            {{-- <div class="text-gray-600">{{ $barang->stok }} Items</div> --}}
                        </a>
                    @endforeach
                </div>
                <div class="grid grid-cols-12 gap-5 mt-5 pt-5 border-t border-theme-5">
                    <a href="javascript:;" data-toggle="modal" data-target="#add-item-modal"
                        ...
                        <div class="box rounded-md p-3 relative zoom-in">
                            ...
                            <div class="block font-medium text-center truncate mt-3">Spaghetti Fettucine Aglio with Beef
                                Bacon</div>
                        </div>
                    </a>
                    <a href="javascript:;" data-toggle="modal" data-target="#add-item-modal"
                    ...
                    <a href="javascript:;" data-toggle="modal" data-target="#add-item-modal"
                        ...
                        <div class="box rounded-md p-3 relative zoom-in">
                            ...
                            <div class="block font-medium text-center truncate mt-3">Spaghetti Fettucine Aglio with Smoked
                                Salmon</div>
                        </div>
                    </a>
                    <a href="javascript:;" data-toggle="modal" data-target="#add-item-modal"
                ...
                <div class="intro-y pr-1">
                    <div class="box p-2">
                        <div class="pos__tabs nav-tabs justify-center flex"> <a data-toggle="tab" data-target="#ticket"
                                href="javascript:;" class="flex-1 py-2 rounded-md text-center active">Ticket</a> <a
                                data-toggle="tab" data-target="#details" href="javascript:;"
                                class="flex-1 py-2 rounded-md text-center">Details</a> </div>
                    </div>
                </div>
                    ...
                    <div class="tab-content__pane active" id="ticket">
                        <div class="pos__ticket box p-2 mt-5">
                            <a href="javascript:;" data-toggle="modal" data-target="#add-item-modal"
                                ...
                                <div class="pos__ticket__item-name truncate mr-1">Spaghetti Fettucine Aglio with Beef Bacon
                                </div>
                ...
                <div class="modal" id="new-order-modal">
                    <div class="modal__content">
                        ...
                        <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
                            ...
                            <div class="col-span-12">
                                {{-- <label>Barang</label>
                                <input type="text" class="input w-full border mt-2 flex-1" placeholder="Nama Barang">  --}}
                                {{-- <div class="mt-3">
                                    <label>Barang</label>
                                    <div class="mt-2">
    ...
    <script>
        $(document).ready(function() {
            // Menangani klik pada link item
            $('a[data-toggle="modal"]').on('click', function() {
                // Mendapatkan data dari atribut data link item
                var namaBarang = $(this).data('nama-barang');
                var stok = $(this).data('stok');

                // Mengatur nilai-nilai dalam modal sesuai dengan data item
                $('#item-name').text(namaBarang);
                // Anda juga dapat mengatur nilai-nilai lain sesuai kebutuhan
