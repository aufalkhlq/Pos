                        ...
                        <div class="dropdown relative ml-auto">
                            ...
                            <div class="dropdown-box mt-5 absolute w-40 top-0 right-0 z-10">
                                <div class="dropdown-box__content box p-2">
                                    <a href="" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md"> <i data-feather="plus" class="w-4 h-4 mr-2"></i> Add Category </a>
                ...
                <div class="intro-y box col-span-12">
                    <div class="flex items-center px-5 py-5 sm:py-3 border-b border-gray-200">
                        ...
                        <div class="dropdown relative ml-auto sm:hidden">
                            ...
                            <div class="dropdown-box mt-5 absolute w-40 top-0 right-0 z-20">
                                <div class="dropdown-box__content box p-2">
                                    <a href="javascript:;" class="flex items-center p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md"> <i data-feather="file" class="w-4 h-4 mr-2"></i> Download XML </a>
                                </div>
                            </div>
                        </div>
                        <button class="button border relative flex items-center text-gray-700 hidden sm:flex"> <i data-feather="file" class="w-4 h-4 mr-2"></i> Download XML </button>
                    </div>
                    <div class="p-5">
                        <div class="grid grid-cols-2 gap-6">
                            <div class="col-span-2 sm:col-span-1 box p-5">
                                ...
                                <div class="flex items-center mt-1 sm:mt-0">
                                    <div class="mr-2 w-20 flex mr-auto"> USP: <span class="ml-3 font-medium text-theme-9">+23%</span> </div>
                            ...
                            <div class="col-span-2 sm:col-span-1 box p-5">
                                ...
                                <div class="flex items-center mt-1 sm:mt-0">
                                    <div class="mr-2 w-20 flex mr-auto"> USP: <span class="ml-3 font-medium text-theme-6">-5%</span> </div>
                                    <div class="w-24 sm:w-32 lg:w-56">
                                        <canvas class="simple-line-chart-1" data-random="true" height="30"></canvas>
                                    </div>
                                </div>
                            ...
                            <div class="col-span-2 sm:col-span-1 box p-5">
                                ...
                                <div class="flex items-center mt-1 sm:mt-0">
                                    <div class="mr-2 w-20 flex mr-auto"> USP: <span class="ml-3 font-medium text-theme-6">-10%</span> </div>
                                    <div class="w-24 sm:w-32 lg:w-56">
                                        <canvas class="simple-line-chart-1" data-random="true" height="30"></canvas>
                                    </div>
                                </div>
                            ...
                            <div class="col-span-2 sm:col-span-1 box p-5">
                                ...
                                <div class="flex items-center mt-1 sm:mt-0">
                                    <div class="mr-2 w-20 flex mr-auto"> USP: <span class="ml-3 font-medium text-theme-9">+55%</span> </div>
                                    <div class="w-24 sm:w-32 lg:w-56">
                                        <canvas class="simple-line-chart-1" data-random="true" height="30"></canvas>
                                    </div>
                                </div>
